...
//#define NET_UPDAT_LEN  16    //wx上传数据长度
...
//定义应用程序回调函数 
#ifndef UIP_APPCALL
#define UIP_APPCALL tcp_client_demo_appcall //定义回调函数为 tcp_demo_appcall 
#endif
/////////////////////////////////////TCP CLIENT/////////////////////////////////////
//extern u8 tcp_client_rxbuf[60];   		//发送数据缓存	 
//extern u8 tcp_client_txbuf[60];   		//发送数据缓存	 
