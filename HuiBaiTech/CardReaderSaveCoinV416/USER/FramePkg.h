...
#define CMP_CONFIG_FQ_WX    			0xe8	//服务器回复测试通信指令
#define CMP_CONFIG_PRICE    			0xe7	//服务器回复测试通信指令
#define CMP_CONFIG_PAR    				0xe5	//服务器回复测试通信指令
#define CMP_ACK_SAVED    					0xe4	//服务器回复测试通信指令
#define CMP_ACK_SAVED_CNT    			0xB1	//服务器回复统计投币数量指令
...
#define DX_UP_ACK_TEST_CMP     	 0x10	//读头回复测试指令
#define DX_UP_TEST_CMP     		 	 0x20	//读头测试指令
#define DX_ACK_OUT_COINOK_CMP    0x40	//读头回复服务器测试上币ok
#define DX_UP_IC_COIN_CMP   		 0x80	//读头上传积分或彩票
#define DX_UP_COIN_CNT_CMP   		 0x81	//机台投币总数量

/***********************************************
简述：协议命令字定义    Wn -> Sn
************************************************/
#define WxACK_CMP_CONFIG_ID    0xfa	//回复服务器配置ID命令
#define WxUP_CMP_Dx_STA   		 0xf9	//回复服务器读头状态
